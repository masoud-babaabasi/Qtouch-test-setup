...
#define NODE_0_PARAMS                                                                                                  \
	{                                                                                                                  \
		X_NONE, Y(4), 12, PRSC_DIV_SEL_12, NODE_GAIN(GAIN_8, GAIN_4), FILTER_LEVEL_32                                  \
	}
#define NODE_1_PARAMS                                                                                                  \
	{                                                                                                                  \
		X_NONE, Y(5), 12, PRSC_DIV_SEL_12, NODE_GAIN(GAIN_8, GAIN_4), FILTER_LEVEL_32                                  \
	}
#define NODE_2_PARAMS                                                                                                  \
	{                                                                                                                  \
		X_NONE, Y(6), 12, PRSC_DIV_SEL_12, NODE_GAIN(GAIN_8, GAIN_4), FILTER_LEVEL_32                                  \
	}
#define NODE_3_PARAMS                                                                                                  \
	{                                                                                                                  \
		X_NONE, Y(7), 6, PRSC_DIV_SEL_12, NODE_GAIN(GAIN_16, GAIN_1), FILTER_LEVEL_32                                  \
	}
#define NODE_4_PARAMS                                                                                                  \
	{                                                                                                                  \
		X_NONE, Y(8), 6, PRSC_DIV_SEL_12, NODE_GAIN(GAIN_16, GAIN_1), FILTER_LEVEL_32                                  \
	}
#define NODE_5_PARAMS                                                                                                  \
	{                                                                                                                  \
		X_NONE, Y(9), 6, PRSC_DIV_SEL_12, NODE_GAIN(GAIN_16, GAIN_1), FILTER_LEVEL_32                                  \
	}
...
#define SCROLLER_0_PARAMS                                                                                              \
	{                                                                                                                  \
		SCROLLER_TYPE_SLIDER, 3, 3, SCROLLER_RESOL_DEADBAND(SCR_RESOL_8_BIT, SCR_DB_10_PERCENT), 8, 20                 \
	}
