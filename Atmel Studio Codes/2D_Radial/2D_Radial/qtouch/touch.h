...
#define NODE_0_PARAMS                                                                                                  \
	{                                                                                                                  \
		X(6) | X(5) | X(4), Y(7), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_12), NODE_GAIN(GAIN_1, GAIN_1),           \
		    FILTER_LEVEL_16                                                                                            \
	}
#define NODE_1_PARAMS                                                                                                  \
	{                                                                                                                  \
		X(6) | X(5) | X(4), Y(8), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_12), NODE_GAIN(GAIN_1, GAIN_1),           \
		    FILTER_LEVEL_16                                                                                            \
	}
#define NODE_2_PARAMS                                                                                                  \
	{                                                                                                                  \
		X(6) | X(5) | X(4), Y(9), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_12), NODE_GAIN(GAIN_1, GAIN_1),           \
		    FILTER_LEVEL_16                                                                                            \
	}
#define NODE_3_PARAMS                                                                                                  \
	{                                                                                                                  \
		X(9) | X(8) | X(7), Y(4), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_12), NODE_GAIN(GAIN_1, GAIN_1),           \
		    FILTER_LEVEL_16                                                                                            \
	}
#define NODE_4_PARAMS                                                                                                  \
	{                                                                                                                  \
		X(9) | X(8) | X(7), Y(5), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_12), NODE_GAIN(GAIN_1, GAIN_1),           \
		    FILTER_LEVEL_16                                                                                            \
	}
#define NODE_5_PARAMS                                                                                                  \
	{                                                                                                                  \
		X(9) | X(8) | X(7), Y(6), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_12), NODE_GAIN(GAIN_1, GAIN_1),           \
		    FILTER_LEVEL_16                                                                                            \
	}
 ...
 */
#define SURFACE_CS_RESOL_DB SCR_RESOL_DEADBAND(RESOL_8_BIT, DB_5_PERCENT)
