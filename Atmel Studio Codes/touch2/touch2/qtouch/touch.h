...
#define NODE_0_PARAMS                                                                                                  \
	{                                                                                                                  \
		X_NONE, Y(11), 0, PRSC_DIV_SEL_12, NODE_GAIN(GAIN_1, GAIN_1), FILTER_LEVEL_16                                  \
	}
#define NODE_1_PARAMS                                                                                                  \
	{                                                                                                                  \
		X_NONE, Y(10), 0, PRSC_DIV_SEL_12, NODE_GAIN(GAIN_1, GAIN_1), FILTER_LEVEL_16                                  \
	}
#define NODE_2_PARAMS                                                                                                  \
	{                                                                                                                  \
		X_NONE, Y(12), 0, PRSC_DIV_SEL_12, NODE_GAIN(GAIN_1, GAIN_1), FILTER_LEVEL_16                                  \
	}
