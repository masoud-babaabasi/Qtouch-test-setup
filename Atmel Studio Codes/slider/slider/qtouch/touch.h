...
#define NODE_0_PARAMS                                                                                                  \
	{                                                                                                                  \
		X_NONE, Y(8), 0, PRSC_DIV_SEL_12, NODE_GAIN(GAIN_8, GAIN_1), FILTER_LEVEL_16                                   \
	}
#define NODE_1_PARAMS                                                                                                  \
	{                                                                                                                  \
		X_NONE, Y(7), 0, PRSC_DIV_SEL_12, NODE_GAIN(GAIN_8, GAIN_1), FILTER_LEVEL_16                                   \
	}
#define NODE_2_PARAMS                                                                                                  \
	{                                                                                                                  \
		X_NONE, Y(9), 0, PRSC_DIV_SEL_12, NODE_GAIN(GAIN_8, GAIN_1), FILTER_LEVEL_16                                   \
	}
...
#define SCROLLER_0_PARAMS                                                                                              \
	{                                                                                                                  \
		SCROLLER_TYPE_SLIDER, 0, 3, SCROLLER_RESOL_DEADBAND(SCR_RESOL_8_BIT, SCR_DB_10_PERCENT), 8, 20                 \
	}
