...
#define NODE_0_PARAMS                                                                                                  \
	{                                                                                                                  \
		X_NONE, Y(0), 0, PRSC_DIV_SEL_12, NODE_GAIN(GAIN_1, GAIN_1), FILTER_LEVEL_16                                   \
	}
#define NODE_1_PARAMS                                                                                                  \
	{                                                                                                                  \
		X_NONE, Y(1), 0, PRSC_DIV_SEL_12, NODE_GAIN(GAIN_1, GAIN_1), FILTER_LEVEL_16                                   \
	}
#define NODE_2_PARAMS                                                                                                  \
	{                                                                                                                  \
		X_NONE, Y(2), 0, PRSC_DIV_SEL_12, NODE_GAIN(GAIN_1, GAIN_1), FILTER_LEVEL_16                                   \
	}
