...
#define NODE_0_PARAMS                                                                                                  \
	{                                                                                                                  \
		X(2) | X(1) | X(0), Y(5), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_12), NODE_GAIN(GAIN_1, GAIN_1),           \
		    FILTER_LEVEL_16                                                                                            \
	}
#define NODE_1_PARAMS                                                                                                  \
	{                                                                                                                  \
		X(2) | X(1) | X(0), Y(4), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_12), NODE_GAIN(GAIN_1, GAIN_1),           \
		    FILTER_LEVEL_16                                                                                            \
	}
#define NODE_2_PARAMS                                                                                                  \
	{                                                                                                                  \
		X(2) | X(1) | X(0), Y(3), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_12), NODE_GAIN(GAIN_1, GAIN_1),           \
		    FILTER_LEVEL_16                                                                                            \
	}
#define NODE_3_PARAMS                                                                                                  \
	{                                                                                                                  \
		X(5) | X(4) | X(3), Y(2), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_12), NODE_GAIN(GAIN_1, GAIN_1),           \
		    FILTER_LEVEL_16                                                                                            \
	}
#define NODE_4_PARAMS                                                                                                  \
	{                                                                                                                  \
		X(5) | X(4) | X(3), Y(1), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_12), NODE_GAIN(GAIN_1, GAIN_1),           \
		    FILTER_LEVEL_16                                                                                            \
	}
#define NODE_5_PARAMS                                                                                                  \
	{                                                                                                                  \
		X(5) | X(4) | X(3), Y(0), 0, NODE_RSEL_PRSC(RSEL_VAL_0, PRSC_DIV_SEL_12), NODE_GAIN(GAIN_1, GAIN_1),           \
		    FILTER_LEVEL_16                                                                                            \
	}
